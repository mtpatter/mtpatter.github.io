...
outer disks and the role of accretion of gas and faint companions in galaxy
evolution.  As a postdoc, I worked on cloud-based analysis pipelines before
returning to astronomy to work with the LSST.
